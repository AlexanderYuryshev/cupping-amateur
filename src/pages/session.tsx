      ...
      <header className="sticky top-0 z-10 flex items-center border-b bg-background px-4 py-3">
        ...
        <Input
          ...
          onChange={(e) => {
            ...
            setSession((prev) => prev && { ...prev, name: newName });
          }}
          placeholder="Название сессии"
          className="h-7 w-64 text-center text-sm font-medium mr-2"
        />
        <div className="flex flex-1 justify-end gap-2">
          ...
          <Button size="sm" onClick={handleComplete} aria-label="Завершить">
